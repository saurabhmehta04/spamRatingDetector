...
import com.team.srdparser.Parser;

public class FileClassifier 
{
	public static ArrayList<String> spamReviewsList = new ArrayList<String>();
	...
	public ArrayList<String> getResult(String sku) throws IOException
	{
		...
		String testPath = pr.getData(sku);
		int spamCount = 0;
		int instanceID = 0;
		...
		while (true) 
		{
			...
			spamReviewsList.add("+"+labels.get(bestCategoryId).toString()+"==>"+review);
		...
		analyzer.close();
		reader.close();
		spamReviewsList.add("+"+Integer.toString(spamCount));
		return spamReviewsList;
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("SPAM COUNT IS: "+fc.getResult("/home/arpeet/Desktop/data.txt"));
		for(int i=0; i<spamReviewsList.size(); i++)
			System.out.println(spamReviewsList.get(i));
	}
}
