			...
			<div class="wrap">
				...
				<div class="menu">
					<ul>
						...
						<li class="login" >
							<p style="color: red;">This is smartphone version</p>
							<div id="loginContainer"><a id="loginButton" href="https://bbyopen.com/api-profiles/reviews-api"><span> + BBY</span></a>
...
<div class="content" >	
	...
	<div class="content_top1 section" id="section-2" style="background:rgb(42,49,61); height: 800px; ">  
		...
		<p style="padding-left: 10%; padding-top: 100px; font-size: 40px; font-family: 'Open Sans'; color: rgb(209,95,34); text-align: center;">
		...
		<div class="banner_desc" style="height:500px; padding: 2em 0 3em 0;"> 
			<div>
				...
				<form method="post" name="input" action="#section-2" id="ratingdropdown">
					<div class="dropdown-buttons">
						<div class="dropdown-button" style="float: left; position: relative; left: 15%;">           			
						...
						<div class="dropdown-button" style="float: left; position: relative; left: 15%;">
							<div class="tester">
								<input id="rating" name="rating" class="rating" type="text" style="border-radius: 5px; margin-right: 10px; height: 55px; font-size: 18px; width: 280px; font-family: 'Raleway'; color: rgb(136,136,136);" placeholder="Enter your review">
							</div>
						</div>
						<div style="clear: both">
							...
							<div id="show-info">
							<input type="submit" value= "Submit" style="margin-top:25px; display:inline-block;
							color:#FFF;
							font-size:1.2em;
							font-weight:400;
							background:#7accc8;
...
<div style="color: rgb(228,115,39); font-size: 8em; ">
<?php 
