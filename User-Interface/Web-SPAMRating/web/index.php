				...
				<div class="menu">
					<ul>
						...
						<li class="login" >
							...
							<div id="loginContainer"><a href="http://bbyopen.com/api-profiles/reviews-api" id="loginButton"><span> + BBY</span></a>
							...
							<div id="small-dialog" class="mfp-hide">
								<div class="priceing-tabel">
									<div class="priceing-header">
										...
										<a href="#">4.2<label> with SPAM ratings </label></a>
										<a href="#">4.1<label> without SPAM ratings </label></a>
